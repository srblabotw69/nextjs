...
module.exports = {OuterScreenBlockPadding, PageTitle, ScreenOuterBlock, ScreenWhiteBlock, TableHolder, PageHeader, Alert, ColumnContainer, PostsContainer, PostBlockContainer, BlackButton}